...
Refinery::Images.configure do |config|
  ...
  config.user_image_sizes = {:default => "570x570", :small=>"110x110>", :medium=>"225x255>", :large=>"450x450>"}
  ...
  # config.dragonfly_secret = "520b1bee4b43fb9f2b6c563d8f9a42ce6890b06a30995370"
  # If you decide to trust file extensions replace :ext below with :format
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.datastore_root_path = "/Users/joshuaaronson/Development/montessori_from_birth/public/system/refinery/images"
